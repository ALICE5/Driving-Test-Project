...
public partial class unit_2 : System.Web.UI.Page
{
    public static int i;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            Business.title_2 tit = new Business.title_2();
            Business.titleData2[] td = tit.Put(Request.QueryString["tittype"], "", "");
    ...
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        Business.title_2 title = new Business.title_2();
        Business.titleData2[] td = title.Select(id);
        if (e.CommandName.ToString().Trim() == td[0].titanswer.Trim())
        {
            //回答正确
    ...
    protected void next_click(object sender, EventArgs e)
    {
        try
        {
            ...
            lbimg.Text = "";
            Business.title_2 tit = new Business.title_2();
            Business.titleData2[] td = tit.Put(Request.QueryString["tittype"], lbid.Text, "next");
            lbtit.Text = td[0].tits;
            if (td[0].titimg != "")
            {
                lbimg.Text = "<img src='admin/uploads/" + td[0].titimg + "'>";
    ...
    protected void last_click(object sender, EventArgs e)
    {
        try
        {
            ...
            lbimg.Text = "";
            Business.title_2 tit = new Business.title_2();
            Business.titleData2[] td = tit.Put(Request.QueryString["tittype"], lbid.Text, "last");
            lbtit.Text = td[0].tits;
            if (td[0].titimg != "")
            {
                lbimg.Text = "<img src='admin/uploads/" + td[0].titimg + "'>";
