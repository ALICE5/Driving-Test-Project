<%@ Page Language="C#" AutoEventWireup="true" CodeFile="title_1tb.aspx.cs" Inherits="title_1tb" %>
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                            <ItemTemplate>
                                <tr style="font-family: Microsoft Yahei;">
                                    ...
                                    <td style="text-align: center;">
                                        <a href='title_1.aspx?id=<%#Eval("Id")%>' style="font-family: Microsoft Yahei;">修改</a>
