<%@ Page Language="C#" AutoEventWireup="true" CodeFile="title_3tb.aspx.cs" Inherits="title_3tb" %>
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                            <ItemTemplate>
                                <tr style="font-family: Microsoft Yahei;">
                                    ...
                                    <td style="text-align: center;">
                                        <a href='title_3.aspx?id=<%#Eval("Id")%>' style="font-family: Microsoft Yahei;">修改</a>
