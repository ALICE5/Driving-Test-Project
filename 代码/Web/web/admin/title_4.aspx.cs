...
public partial class title_4 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["id"] != null)
            {
                ...
                Business.title_4 ey = new Business.title_4();
                Business.titleData4[] ed = ey.Select(Request.QueryString["id"]);
                ...
                Business.title_4.titimg = ed[0].titimg;
    ...
    {
        Business.title_4 ey = new Business.title_4();
        Business.titleData4 ed = new Business.titleData4();

        ed.tittype = "机动车驾驶操作相关基础知识";
        ...
        Response.Redirect("title_4tb.aspx");
