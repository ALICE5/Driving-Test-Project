...
public partial class unit_1 : System.Web.UI.Page
{
    public static int i;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            if (Request.QueryString["is"] == "0")//判断用户是否注销
            {
            ...
            Business.titleData1[] td = tit.Put(Request.QueryString["tittype"], "", "");
            ...
            Repeater1.DataSource = tit.Frist(Request.QueryString["tittype"]);//显示选项
            Repeater1.DataBind();
            tit = null;
            td = null;
        }
    ...
    protected void next_click(object sender, EventArgs e)
    {
        try
        {
            ...
            lbimg.Text = "";
            Business.title_1 tit = new Business.title_1();
            Business.titleData1[] td = tit.Put(Request.QueryString["tittype"], lbid.Text, "next");
            lbtit.Text = td[0].tits;
            if (td[0].titimg != "")
            {
                lbimg.Text = "<img src='admin/uploads/" + td[0].titimg + "'>";
    ...
    protected void last_click(object sender, EventArgs e)
    {
        try
        {
            ...
            lbimg.Text = "";
            Business.title_1 tit = new Business.title_1();
            Business.titleData1[] td = tit.Put(Request.QueryString["tittype"], lbid.Text, "last");
            lbtit.Text = td[0].tits;
            if (td[0].titimg != "")
            {
                lbimg.Text = "<img src='admin/uploads/" + td[0].titimg + "'>";
            ...
            Repeater1.DataBind();//Repeater绑定的目的是显示选项
            lbid.Text = td[0].Id;
            i -= 1; lbnum.Text = i.ToString();
            tit = null;
            td = null;
    ...
    protected void rdbtnA_CheckedChanged(object sender, EventArgs e)
    {
        foreach (RepeaterItem item in Repeater1.Items)
        {
            ...
            string id = rdbtn.CommandArgument.ToString().Trim();//首先取得当前题目的id
            Business.title_1 title = new Business.title_1();
            Business.titleData1[] td = title.Select(id);
