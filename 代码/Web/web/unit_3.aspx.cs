...
public partial class unit_3 : System.Web.UI.Page
{
    public static int i;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            Business.title_3 tit = new Business.title_3();
            Business.titleData3[] td = tit.Put(Request.QueryString["tittype"], "", "");
    ...
    protected void next_click(object sender, EventArgs e)
    {
        try
        {
            ...
            lbimg.Text = "";
            Business.title_3 tit = new Business.title_3();
            Business.titleData3[] td = tit.Put(Request.QueryString["tittype"], lbid.Text, "next");
            lbtit.Text = td[0].tits;
            if (td[0].titimg != "")
            {
                lbimg.Text = "<img src='admin/uploads/" + td[0].titimg + "'>";
    ...
    protected void last_click(object sender, EventArgs e)
    {
        try
        {
            ...
            lbimg.Text = "";
            Business.title_3 tit = new Business.title_3();
            Business.titleData3[] td = tit.Put(Request.QueryString["tittype"], lbid.Text, "last");
            lbtit.Text = td[0].tits;
            if (td[0].titimg != "")
            {
                lbimg.Text = "<img src='admin/uploads/" + td[0].titimg + "'>";
    ...
    protected void rdbtnA_CheckedChanged(object sender, EventArgs e)
    {
        foreach (RepeaterItem item in Repeater1.Items)
        {
            ...
            Business.title_3 title = new Business.title_3();
            Business.titleData3[] td = title.Select(id);
