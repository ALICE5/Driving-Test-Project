...
public partial class paper : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            Business.banks title = new Business.banks();
            Repeater1.DataSource = title.Out(Request.QueryString["ptit"]);
            Repeater1.DataBind();
            lblTitle.Text = Request.QueryString["ptit"].ToString();
            title = null;
            i = 0;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            string mychose = "";
            RadioButton rb1 = (RadioButton)ri.FindControl("A");//找到ID为A的RadioButton
            ...
            if (rb1.Checked == true) { mychose = "A"; }//得到用户关于当前题目的选项
