...
<script type="text/javascript">
    ...
    function rightchose(id) {
        var choseid = "#EOV" + id;
        $(choseid).removeClass().addClass("ExamOrderViewVisited");//将id为choseid的元素的类删除并添加指定类
        ...
        <div style="float: right; position: relative; width: 300px;">
            ...
            <div id="tips" style="_width: 300px; _overflow: hidden">
                ...
                <div id="Div1" style="margin: 10px 15px; width: 100%;">
                    <font color="gray">剩余时间:</font> <span style="color: red; font-size: 28px; font-family: Arial;">
                        ...
                        <script language="JavaScript">   
                            ...
                            function CountDown() {
                                if (maxtime >= 0) {
                                    ...
                                    document.all["timer"].innerHTML = msg; //在timer层显示msg字符串
                            ...
                            timer = setInterval("CountDown()", 1000); //间隔指定的毫秒数不停地执行指定的代码
                ...
                <div style="padding: 10px 0">
                    <span class="slslw"></span>未答题<span class="slsly"></span>已答题
    ...
    <div class="right fleft">
        <div class="rightcon" style="height: auto">
            <div class="righttllllluu">
                <div class="bgbg">
                    <span class="mnkstttt"><span class="mnkstkl">小车科目一理论知识模拟考试</span>
                    </span>
                    <br>
                    <div class="ttttsdsds">
