...
namespace Business
{
    ...
    public class title_4
    {
        ...
        public bool Insert(titleData4 dattitle_1)
        {
            int iRel = -1;
            bool bRel = false;
        ...
        public bool Modify(titleData4 dattitle_1)
        {
            int iRel = -1;
            bool bRel = false;
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
        ...
        public titleData4[] Select(string Id)
        {
            int iRel = -1;
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            titleData4[] dattitle_1 = new titleData4[1];
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (nRow > 0)
                    {
                        dattitle_1 = new titleData4[nRow];
                        for (int i = 0; i < nRow; i++)
                        {
                            dattitle_1[i] = new titleData4();
        ...
        public titleData4[] Put(string tittype, string id, string type)
        {
            int iRel = -1;
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            titleData4[] dattitle_1 = new titleData4[1];
            ...
            {
                sql = "select top 1 * from title_4 where tittype ='" + tittype + "' and id <'" + id + "' order by id DESC";
            }
            try
            {
                objDB.OpenConnection();
        ...
        public titleData4[] PutMyError(string id, string type, string userid)
        {
            int iRel = -1;
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            titleData4[] dattitle_1 = new titleData4[1];
