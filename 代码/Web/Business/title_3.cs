...
namespace Business
{
    ...
    public class title_3
    {
        ...
        public bool Insert(titleData3 dattitle_1)
        {
            int iRel = -1;
            bool bRel = false;
            ...
            try
            {
                ...
                string strSql = " insert into title_3 (tittype,tits,titimg,titchose,titanswer,titparsing,titlevel)  values (@tittype,@tits,@titimg,@titchose,@titanswer,@titparsing,@titlevel) ";
        ...
        public bool Modify(titleData3 dattitle_1)
        {
            int iRel = -1;
            bool bRel = false;
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            ...
            {
                objDB.OpenConnection();
                string strSql = "update title_3 set tittype=@tittype,tits=@tits,titimg=@titimg,titchose=@titchose,titanswer=@titanswer,titparsing=@titparsing,titlevel=@titlevel where Id = @Id";
                objDB.Command.CommandType = System.Data.CommandType.Text;
                objDB.Command.CommandText = strSql;
                objDB.Command.Parameters.AddWithValue("@tittype", dattitle_1.tittype);
                objDB.Command.Parameters.AddWithValue("@tits", dattitle_1.tits);
        ...
        public bool Delete(string Id)
        {
            ...
            {
                objDB.OpenConnection();
                string strSql = "delete from title_3 where Id=" + Id + "";
                objDB.Command.CommandType = System.Data.CommandType.Text;
                objDB.Command.CommandText = strSql;
                iRel = objDB.Command.ExecuteNonQuery();
            }
        ...
        public titleData3[] Select(string Id)
        {
            int iRel = -1;
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            titleData3[] dattitle_1 = new titleData3[1];
            string sql = "select * from title_3 where Id= " + Id + " ";
            try
            {
                objDB.OpenConnection();
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (nRow > 0)
                    {
                        dattitle_1 = new titleData3[nRow];
                        for (int i = 0; i < nRow; i++)
                        {
                            dattitle_1[i] = new titleData3();
        ...
        public titleData3[] Put(string tittype, string id, string type)
        {
            int iRel = -1;
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            titleData3[] dattitle_1 = new titleData3[1];
            ...
            if (id == "")
            {
                sql = "select top 1 * from title_3 where tittype ='" + tittype + "' ";
            }
            else if (type == "next")
            {
                sql = "select top 1 * from title_3 where tittype ='" + tittype + "' and id >'" + id + "' ";
            }
            else if (type == "last")
            {
                sql = "select top 1 * from title_3 where tittype ='" + tittype + "' and id <'" + id + "' order by id DESC";
            }
            try
            {
                objDB.OpenConnection();
        ...
        public titleData3[] PutMyError(string id, string type, string userid)
        {
            int iRel = -1;
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            titleData3[] dattitle_1 = new titleData3[1];
            ...
            if (id == "")
            {
                sql = "select top 1 * from title_3 where id in (select errorid from errortit where userid ='" + userid + "')";
            }
            else if (type == "next")
            {
                sql = "select top 1 * from title_3 where id >'" + id + "'  and id in (select errorid from errortit where userid ='" + userid + "')";
            }
            else if (type == "last")
            {
                sql = "select top 1 * from title_3 where id <'" + id + "' and id in (select errorid from errortit where userid ='" + userid + "')";
        ...
        public DataTable Get()
        {
            ...
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            string sql = "select * from title_3";
            objDB.OpenConnection();
        ...
        public DataTable GetRandom()
        {
            ...
            DataTable dt = new DataTable();
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            string sql = "select top 10 * from title_3 Order By Rnd(" + (-1 * intRandomNumber) + "*id) union all (select top 10 * from title_2 Order By Rnd(" + (-1 * intRandomNumber) + "*id)) union all (select top 15 * from title_3 Order By Rnd(" + (-1 * intRandomNumber) + "*id)) union all (select top 15 * from title_4 Order By Rnd(" + (-1 * intRandomNumber) + "*id))";
            objDB.OpenConnection();
            dt = objDB.QueryDataTable(sql, "tabname");
            objDB.CloseConnection();
            objDB.Dispose();
        ...
        public DataTable GetRd()
        {
            ...
            DataTable dt = new DataTable();
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            string sql = "SELECT TOP 50 * FROM title_3 ORDER BY Rnd(id) ";
            objDB.OpenConnection();
            dt = objDB.QueryDataTable(sql, "tabname");
            objDB.CloseConnection();
            objDB.Dispose();
        ...
        public DataTable Frist(string tittype)
        {
            DataTable dt = new DataTable();
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            string sql = "select top 1 * from title_3 where tittype ='" + tittype + "'";
            objDB.OpenConnection();
            dt = objDB.QueryDataTable(sql, "tabname");
            objDB.CloseConnection();
            objDB.Dispose();
        ...
        public DataTable Next(string tittype, string id)
        {
            DataTable dt = new DataTable();
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            string sql = "select top 1 * from title_3 where tittype ='" + tittype + "' and id >'" + id + "'";
            objDB.OpenConnection();
            dt = objDB.QueryDataTable(sql, "tabname");
            objDB.CloseConnection();
            objDB.Dispose();
        ...
        public DataTable MyFrist(string tittype, string userid)
        {
            DataTable dt = new DataTable();
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            string sql = "select top 1 * from title_3 where  id in (select errorid from errortit where userid ='" + userid + "')";
            objDB.OpenConnection();
            dt = objDB.QueryDataTable(sql, "tabname");
            objDB.CloseConnection();
            objDB.Dispose();
        ...
        public DataTable MyNext(string tittype, string id, string userid)
        {
            DataTable dt = new DataTable();
            DataAccess.CommonDB objDB = new DataAccess.CommonDB();
            string sql = "select top 1 * from title_3 where  id >'" + id + "' and id in (select errorid from errortit where userid ='" + userid + "')";
            objDB.OpenConnection();
            dt = objDB.QueryDataTable(sql, "tabname");
            objDB.CloseConnection();
            objDB.Dispose();
